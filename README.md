...
•	Ranking (Top products per region)
...
•	Aggregate (Cumulative Sales per Product)
...
•	Navigation (Compare Current vs. Previous Sale)
...
•	Distribution (Customer Spending Quartiles)
...
•	Average (Regional Sales Averages)
